module Examples.ExBlackHolesPPos where
...
fa1 : A1
fa1 a = a1 a ! V 1.2 {refl}

fa2 : A2
fa2 a b = a2 a b ! V 1.4 {refl}

fa4 : A4
fa4 x y = a4 x y ! V 3.0 {refl}

fs4-9 : S4-9
fs4-9 x = s4-9 x ! V 1.0 {refl}

fs9-4 : S9-4
fs9-4 x = s9-4 x ! V 1.0 {refl}
